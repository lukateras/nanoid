...
* Python
  - [чистая](https://github.com/puyuan/py-nanoid)
  - [cо словарями](https://pypi.org/project/nanoid-dictionary)
  - [быстрая на Rust](https://github.com/oliverlambson/fastnanoid)
* Postgres
  - [расширение на Rust](https://github.com/spa5k/uids-postgres)
  - [функция на чистом PL/pgSQL](https://github.com/viascom/nanoid-postgres)
* [R (со словарями)](https://github.com/hrbrmstr/nanoid)
